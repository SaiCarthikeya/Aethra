...
const Body = () => {
    const [inputText, setInputText] = useState("Type your message...");
    return (
        <div className="flex-1 bg-gray-900 p-4 flex justify-end items-center flex-col pb-36">
        <MessagesContainer />
         <div
  className="w-full max-w-2xl mt-4 flex items-center gap-2 transition-transform duration-200 hover:scale-105"
>
  <input
    type="text"
    value={inputText}
