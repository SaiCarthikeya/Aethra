...
const MessagesContainer = () => {
  ...
  return (
    <>
    <div className="text-white md:m-4 flex flex-col w-[90%] h-[100%] overflow-y-auto rounded-lg p-2
    ...
    {cur_messages.length > 1 && (
    <span className="ml-auto mr-6 mb-0 md:mr-12 border-red-500 md:border-2 md:border-solid rounded-lg md:p-3 hover:bg-red-200 text-4xl text-[#ff3366]" onClick={() => clearMessages()}>
      <MdDeleteForever />
    </span>
  )}
